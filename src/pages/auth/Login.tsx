  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        ...
        description: "This is a mock login. Firebase authentication will be implemented soon.",
      });
    } catch (error) {
      toast({
        title: "Login Failed",
      ...
      <Card className="w-full">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <div className="flex items-center justify-between mb-1">
                ...
                <Link
                  to="/forgot-password"
                  className="text-sm text-edu-blue-600 hover:text-edu-blue-800"
                >
                  Forgot password?
                </Link>
              </div>
        ...
        <CardFooter className="flex justify-center">
          <p className="text-sm text-gray-600">
            ...
            <Link to="/signup" className="text-edu-blue-600 hover:text-edu-blue-800 font-medium">
              Sign up
            </Link>
          </p>
        </CardFooter>
