    ...
    <footer className="bg-gray-900 text-gray-300">
      <div className="container-custom py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2 lg:col-span-1">
            <Link to="/" className="flex items-center gap-2 mb-4">
              <span className="text-2xl font-bold text-white">
                Edu<span className="text-edu-purple-400">Nex</span>
              </span>
            </Link>
            <p className="text-sm text-gray-400 mb-4">
              Empowering Nepali students with quality education and career guidance through innovative learning experiences and resources.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/career-tools" className="text-gray-400 hover:text-white transition-colors duration-200">Career Tools</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/faq" className="text-gray-400 hover:text-white transition-colors duration-200">FAQs</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              ...
              <li className="flex items-start space-x-2">
                <span>📧</span>
                <a href="mailto:info@edunexnepal.com" className="hover:text-white transition-colors duration-200">info@edunexnepal.com</a>
              </li>
              <li className="flex items-start space-x-2">
                <span>📞</span>
                <a href="tel:+9771234567" className="hover:text-white transition-colors duration-200">+977-1-234567</a>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="mt-10 pt-6 border-t border-gray-800 text-center text-sm text-gray-400">
          <p>© {new Date().getFullYear()} Edu Nex Nepal. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
